        ...
        <div className="divide-y divide-gray-200">
          {upcomingSessions.length === 0 ? (
            <div className="p-6 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">Schedule your first mentoring session to get started.</p>
            </div>
          ) : (
            upcomingSessions.map((session) => (
      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <nav className="flex space-x-1 bg-gray-100 p-1 rounded-lg" aria-label="Tabs">
              <button
                ...
                } px-3 py-2 font-medium text-sm rounded-md transition-all`}
              >
                Overview
              </button>
              <button
          ...
          <div className="mt-2">
            ...
            {activeTab === 'mentees' && renderMentees()}
            {activeTab === 'tasks' && <TaskManagement />}
            {activeTab === 'meetings' && <MentorMeetings />}
          </div>
        </div>
      </div>
    </div>
